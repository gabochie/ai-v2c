      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-6 flex-1 text-xs">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div>
              <label className="block text-slate-400 font-mono font-medium mb-1">Actual Hours Spent</label>
              <input
                type="number"
                min={0}
                max={200}
          ...
          <div>
            ...
            <div className={`p-3 rounded-xl border max-h-36 overflow-y-auto space-y-1.5 ${
              ...
              {allTasks
                ...
                .map((otherTask) => {
                  ...
                  return (
                    <label
                      key={otherTask.id}
                      className="flex items-center justify-between p-1.5 rounded hover:bg-slate-700/20 cursor-pointer"
                    >
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="font-medium text-slate-200">{otherTask.title}</span>
                      </div>
                      <span className="text-[10px] font-mono text-slate-400">{otherTask.status}</span>
                    </label>
                  );
                })}
            </div>
